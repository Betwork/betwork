...
RSpec.describe "Bets", type: :request do
  it "should be able to make a bet and see it in their my bets" do
    @u1 = User.create!(name: 'Betty', email: 'Betty@betwork.com', password: 'password', actualBalance: 1000)
    @u1.skip_confirmation!
    @u1.save!
    @u2 = User.create!(name: 'Betty1', email: 'Betty1@betwork.com', password: 'password1', actualBalance: 2000)
