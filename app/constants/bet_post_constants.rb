...
MESSAGE_PART_TWO_WON = "</a></span>&nbsp;has won a bet for $"
...
def create_bet_won_message_string(user_one, user_two, bet)
    return MESSAGE_PART_ONE + "\"/users/" + user_one.id.to_s + "\">" + user_one.name + MESSAGE_PART_TWO_WON + bet.amount.to_s + MESSAGE_PART_THREE + "\"/users/" + user_two.id.to_s + "\">" + user_two.name + MESSAGE_PART_FOUR
end
